			...
			<div class="content-wrapper">
				<div class="row">
					...
					<div class="col-sm-10 col-md-10">
						...
						<h3 class="text-left text-muted2 mb-4" style="color: #fff;font-size:30px">{{ trans('messages.installation') }} | <a href="https://weadown.com" target="_blank">weadown.com</a></h3>
